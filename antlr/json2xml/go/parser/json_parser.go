...
func (s *AnObjectContext) LCURLY() antlr.TerminalNode {
	return s.GetToken(JSONParserLCURLY, 0)
}
...
func (s *NullObjectContext) LCURLY() antlr.TerminalNode {
	return s.GetToken(JSONParserLCURLY, 0)
}
...
func (s *ArrayOfValuesContext) LBRACK() antlr.TerminalNode {
	return s.GetToken(JSONParserLBRACK, 0)
}
...
func (s *NullArrayContext) LBRACK() antlr.TerminalNode {
	return s.GetToken(JSONParserLBRACK, 0)
}
