...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','yacc.py',12),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','yacc.py',16),
  ('expression -> term','expression',1,'p_expression_term','yacc.py',20),
  ('term -> term TIMES factor','term',3,'p_term_times','yacc.py',24),
  ('term -> term DIVIDE factor','term',3,'p_term_div','yacc.py',28),
  ('term -> factor','term',1,'p_term_factor','yacc.py',32),
  ('factor -> NUMBER','factor',1,'p_factor_num','yacc.py',36),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','yacc.py',40),
]
